...
static const char *fonts[]          = { "JetBrains Mono:size=18.5" };
static const char dmenufont[]       = "JetBrains Mono:size=18.5";
...
/* tagging */
static const char *tags[] = { "dev", "web", "fil", "vir", "edi", "soc", "aud", "gam", "oth"};
...
static const Key keys[] = {
	...
	{ MODKEY,          	            XK_Return, spawn,          SHCMD("kitty -e tmux") },
